        ...
        while epochs < num_epochs:
            ...
            while step_in_epoch < epoch_size:   
                ...
                while not done: # 本轨迹未结束
                    ...
                    #     break
            print("[Train_epoch %d]\n" % (epochs + 1)," Total_steps_till_now:", global_step, "Success_rate{:.5f}".format(success_num/episode_num),
                  "Time:{:.2f}s".format(time()-epoch_strat_time), "Add_rate:{:.5f}", self._env.env.add_rate , "\n""Epoch_average_reward:{:.2f}", total_reward/episode_num)
